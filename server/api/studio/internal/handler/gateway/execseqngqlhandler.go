...
func ExecSeqNGQLHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ExecNGQLParams
		...
		l := gateway.NewExecSeqNGQLLogic(r.Context(), svcCtx)
		data, err := l.ExecSeqNGQL(req)
