...
func GetManyImportTaskHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetManyImportTaskRequest
		...
		l := importtask.NewGetManyImportTaskLogic(r.Context(), svcCtx)
		data, err := l.GetManyImportTask(req)
