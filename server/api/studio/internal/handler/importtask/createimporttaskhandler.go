...
func CreateImportTaskHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateImportTaskRequest
		...
		l := importtask.NewCreateImportTaskLogic(r.Context(), svcCtx)
		data, err := l.CreateImportTask(req)
