...
func UpdateTaskDraftHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateTaskDraftRequest
		...
		l := importtask.NewUpdateTaskDraftLogic(r.Context(), svcCtx)
		err := l.UpdateTaskDraft(req)
		svcCtx.ResponseHandler.Handle(w, r, nil, err)
	}
}
