...
func DeleteLLMImportJobHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteLLMImportRequest
		...
		l := llm.NewDeleteLLMImportJobLogic(r.Context(), svcCtx)
		data, err := l.DeleteLLMImportJob(req)
