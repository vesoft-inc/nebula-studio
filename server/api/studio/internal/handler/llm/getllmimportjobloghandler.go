...
func GetLLMImportJobLogHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LLMImportLogRequest
		...
		l := llm.NewGetLLMImportJobLogLogic(r.Context(), svcCtx)
		data, err := l.GetLLMImportJobLog(req)
