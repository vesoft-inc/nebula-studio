...
func GetLLMImportJobsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LLMImportJobsRequest
		...
		l := llm.NewGetLLMImportJobsLogic(r.Context(), svcCtx)
		data, err := l.GetLLMImportJobs(req)
