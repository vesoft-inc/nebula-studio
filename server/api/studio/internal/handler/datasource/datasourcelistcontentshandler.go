...
func DatasourceListContentsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DatasourceListContentsRequest
		...
		l := datasource.NewDatasourceListContentsLogic(r.Context(), svcCtx)
		data, err := l.DatasourceListContents(req)
