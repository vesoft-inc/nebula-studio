...
func DatasourcePreviewFileHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DatasourcePreviewFileRequest
		...
		l := datasource.NewDatasourcePreviewFileLogic(r.Context(), svcCtx)
		data, err := l.DatasourcePreviewFile(req)
