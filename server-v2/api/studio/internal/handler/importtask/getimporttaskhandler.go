...
func GetImportTaskHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetImportTaskRequest
		...
		l := importtask.NewGetImportTaskLogic(r.Context(), svcCtx)
		data, err := l.GetImportTask(req)
