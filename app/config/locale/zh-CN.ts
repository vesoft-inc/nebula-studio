export default {
  ...
  import: {
    ...
    datasourceCreator: '创建者',
    datasourceGrant: '授权',
    datasourceGrantManage: '管理数据源授权 - {name}',
    datasourceGrantTips: '创建者：{creator}。root 可管理全部 S3/SFTP 数据源授权。',
    selectGrantUsers: '选择要授权的用户',
    noDatasourceGrantUsers: '暂无已授权用户',
    datasourceGrantPermissionTip: '仅 root 或创建者可管理授权',
    datasourceUsersLoadFailed: '用户列表加载失败，请手动输入用户名',
    ipAddress: 'IP 地址：端口',
    ...
    rollbackConfirm: '确认回滚该导入任务吗？已导入的数据将被删除。',
  ...
  link: {
    ...
    mannualHref: 'https://docs.nebula-graph.com.cn/3.8.0/nebula-studio/about-studio/st-ug-what-is-graph-studio/',
    startStudioHref: 'https://docs.nebula-graph.com.cn/3.8.0/nebula-studio/quick-start/st-ug-plan-schema/',
    ...
    loginHref: 'https://docs.nebula-graph.com.cn/3.8.0/nebula-studio/deploy-connect/st-ug-connect/',
  },
  sketch: {
    dragTip: '拖放到画布上',
    tag: '标签',
  ...
  welcome: {
    ...
    sketchModuleLink: 'https://docs.nebula-graph.com.cn/3.8.0/nebula-studio/quick-start/draft/',
  ...
  setting: {
    ...
    llmImport: 'AI 导入',
    llmImportDesc: '使用 LLM 和 Nebula Graph 构建知识图谱，位于导入数据 --> 新建 AI 导入',
