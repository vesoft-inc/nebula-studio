export default {
  ...
  doc: {
    ...
    consoleIntro:
      'When data is imported, you can use the Console page to query graph data.',
    ...
    snsIntro:
      'Social Network Graph demo, new friend recommendation, feed generation, etc.',
    ...
    idMappingIntro:
      'ID Mapping, Identity Resolution for a user system in Graph',
    fifa2022Intro:
    ...
    fraudDetectionIntro:
      'Fraud detection with Graph, taking loan application as an example',
  },
  warning: {
  ...
  formRules: {
    ...
    nameValidate:
      'The name must start with a letter, and it only supports English letters, numbers and underscores',
    nameRequired: 'Please enter the name',
    numberRequired: 'Please enter a positive integer',
    replicaLimit:
      'Replica factor must not exceed the number of your current online machines({number})',
    ttlRequired:
  ...
  console: {
    ...
    exportVertex:
      'Please choose the column representing vertex IDs from the table',
    exportEdge:
      'Please choose the columns representing source vertex ID, destination vertex ID, and rank of an edge',
    ...
    gptAPITooltip: 'please use chat completions api',
    gptModelVersion: 'GPT Model Version',
    features: 'Features',
    docLength: 'Max doc text length',
    useSpaceSchema: 'Use space schema',
    useConsoleNGQL: 'Use console nGQL',
    send: 'Send',
    explain: 'Explain',
    gptIconTip: 'Use GPT to explain the query',
    copilotTip: 'Use Copilot to complete the query',
    copyGPT2NGQL: 'Copy to Console',
  },
  explore: {
  ...
  import: {
    ...
    templateMatchError:
      'The user in the configuration does not match the current login account',
    ...
    noHttp:
      'The address in the configuration file does not support http protocol, please remove http(s)://',
    addressMatch:
    ...
    vidFunctionTip:
      'Function to generate VID. Currently only hash functions are supported.',
    ...
    fileRepeatTip:
      'These files are already exists, continuing to upload will overwrite the original file',
    ...
    addNewImportTip:
      'After adding the data source, create an import task to import the data into the database',
    start: 'Start',
    s3Tip:
      'Only support cloud services that compatible with the Amazon S3 interface',
    readerConcurrency: 'Reader concurrency',
    readerConcurrencyTip:
      'The number of concurrent readers that read data from the data source',
    ...
    account: 'Account',
    endpointTip:
      'Please use an endpoint without a bucket name in the domain name, e.g. {sample}',
    ...
    addressRequired:
      'Please enter the import address in the configuration file',
    ...
    s3AccessKeyRequired:
      'Please enter the s3 accessKeyID in the configuration file',
    s3SecretKeyRequired:
      'Please enter the s3 accessKeySecret in the configuration file',
    sftpUsernameRequired:
      'Please enter the sftp username in the configuration file',
    sftpPasswordRequired:
      'Please enter the sftp password in the configuration file',
    ossAccessKeyRequired:
      'Please enter the oss accessKeyID in the configuration file',
    ossSecretKeyRequired:
      'Please enter the oss accessKeySecret in the configuration file',
    draft: 'Draft',
    ...
    rerunError:
      'The task configuration record cannot be found, and the task cannot be rerun',
    editTaskError:
      'Cannot find task configuration record, cannot continue editing',
  },
  schema: {
    ...
    dateFormat:
      'Supported data inserting methods: <br />Call function date(), for example: date(\'2021-03-17\')',
    timeFormat:
      'Supported data inserting methods: <br />Call function time(), for example: time(\'17:53:59\')',
    datetimeFormat:
  ...
  link: {
    nGQLHref:
      'https://docs.nebula-graph.io/3.5.0/3.ngql-guide/1.nGQL-overview/1.overview/',
    mannualHref:
      'https://docs.nebula-graph.io/3.5.0/nebula-studio/about-studio/st-ug-what-is-graph-studio/',
    startStudioHref:
      'https://docs.nebula-graph.io/3.5.0/nebula-studio/quick-start/st-ug-plan-schema/',
    versionLogHref:
      'https://docs.nebula-graph.io/3.5.0/20.appendix/release-notes/studio-release-note/',
    ...
    loginHref:
      'https://docs.nebula-graph.io/3.5.0/nebula-studio/deploy-connect/st-ug-connect/',
  },
  sketch: {
    ...
    saveReminder:
      'The current sketch has been modified but not saved, whether to continue to switch sketches?',
    saveTip:
      'The current sketch has been modified but not saved, please save first.',
    confirmDelete: 'Sure to delete?',
    saveDraft: 'Save draft',
    export: 'Export',
    applySpaceTip:
      'The new schema will not overwrite the original schema in the space',
    sameSchemaWarning:
  ...
  welcome: {
    ...
    schemaModuleLink:
      'https://docs.nebula-graph.io/3.5.0/nebula-studio/quick-start/st-ug-create-schema/',
    importModuleLink:
      'https://docs.nebula-graph.io/3.5.0/nebula-studio/quick-start/st-ug-import-data/',
    consoleModuleLink:
      'https://docs.nebula-graph.io/3.5.0/nebula-studio/quick-start/st-ug-console/',
    sketchModuleLink:
      'https://docs.nebula-graph.io/3.5.0/nebula-studio/quick-start/draft/',
    ...
    movieDocLink: '',
    idMappingDocLink: '',
    fraudDetectionDocLink:
      'https://siwei.io/en/fraud-detection-with-nebulagraph/',
    fifa2022DocLink:
      'https://siwei.io/en/chatgpt-and-nebulagraph-predict-fifa-world-cup/',
