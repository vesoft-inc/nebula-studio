export default {
  ...
  import: {
    ...
    datasourceGrant: 'Grant',
    datasourceGrantManage: 'Manage datasource grants - {name}',
    datasourceGrantTips: 'Creator: {creator}. Root can manage all S3/SFTP datasource grants.',
    selectGrantUsers: 'Select users to grant',
    noDatasourceGrantUsers: 'No granted users',
    datasourceGrantPermissionTip: 'Only root or creator can manage grants',
    datasourceUsersLoadFailed: 'Failed to load users list, please input usernames manually',
    ...
    rollbackConfirm: 'Are you sure to rollback this import task? Imported data will be deleted.',
  ...
  link: {
    ...
    mannualHref: 'https://docs.nebula-graph.io/3.8.0/nebula-studio/about-studio/st-ug-what-is-graph-studio/',
    startStudioHref: 'https://docs.nebula-graph.io/3.8.0/nebula-studio/quick-start/st-ug-plan-schema/',
    ...
    loginHref: 'https://docs.nebula-graph.io/3.8.0/nebula-studio/deploy-connect/st-ug-connect/',
  },
  sketch: {
  ...
  welcome: {
    ...
    schemaModuleLink: 'https://docs.nebula-graph.io/3.8.0/nebula-studio/quick-start/st-ug-create-schema/',
    importModuleLink: 'https://docs.nebula-graph.io/3.8.0/nebula-studio/quick-start/st-ug-import-data/',
    consoleModuleLink: 'https://docs.nebula-graph.io/3.8.0/nebula-studio/quick-start/st-ug-console/',
    sketchModuleLink: 'https://docs.nebula-graph.io/3.8.0/nebula-studio/quick-start/draft/',
  ...
  setting: {
    ...
    betaFunction: 'Beta Functions',
    viewScmemaBetaFunDesc:
      'View the schema structure of the specified graph space, located at Schema-> Operations-> View Schema',
    text2query: 'Text to Query',
    text2queryDesc: 'You can use the LLM capability to write query statements in the console',
    llmImport: 'AI Import',
    llmImportDesc: 'Knowledge Graph Build with LLM and NebulaGraph, located at Import data -> New AI Import',
    maxTextLength: 'Max Text Length',
    verify: 'Verify',
  },
  llm: {
    newAiImport: 'New AI Import',
    importTip: 'Please create the schema before creating an import task.',
    setup: 'Setup',
    confirm: 'Confirm',
    file: 'File',
    filePath: 'File Path',
    ...
    tokenTip:
      'The current token consumption is an estimated value, and there may be some differences from the actual consumption in the end.',
    fileRequired: 'Please select the file',
  },
};
